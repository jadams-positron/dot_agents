...
| `work-gh-issues` | Fan out GitHub issues into independent Agent Deck Codex sessions with isolated worktrees, shared quality gates, and interactive issue-number collection. |
